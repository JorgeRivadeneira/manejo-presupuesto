...
namespace ManejoPresupuesto.Controllers
{
    public class TiposCuentasController : Controller
    {
        ...
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var tipoCuenta = await repositorioTiposCuentas.ObtneterPorId(id, usuarioId);
        ...
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var tipoCuentaExiste = await repositorioTiposCuentas.ObtneterPorId(tipoCuenta.Id, usuarioId);
